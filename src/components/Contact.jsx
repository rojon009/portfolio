    ...
    return (
        <div className="dark:text-white">
            ...
            <form onSubmit={hanldeSubmit} className="flex flex-col space-y-2">
                <input value={formInfo.name} onChange={(e) => handleChange(e)} required className="border border-grish px-3 py-2 rounded-md" type="text" name="name" placeholder="Your name" />
                <input value={formInfo.email} onChange={handleChange} required className="border border-grish px-3 py-2 rounded-md" type="email" name="email" id="email" placeholder="Your Email" />
                <textarea value={formInfo.message} onChange={handleChange} required className="border border-grish px-3 py-2 rounded-md" name="message" id="" cols="30" rows="10" placeholder="Your Message"></textarea>
